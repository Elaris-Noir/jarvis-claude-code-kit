---
description: Jarvis build workflow. Designs, implements, reviews, and hardens a feature end-to-end.
agent: jarvis
---

# # Jarvis Build Command

Jarvis collaborative development workflow (Research → Plan → Build → Test → Optimize → Review).
Jarvis orchestrates specialized agents to complete tasks.
...
- Jarvis orchestration: planner → builder → reviewer → security-reviewer
